...
export default function DashboardProfile() {
  ...
  const [imageUploadingProgressError, setImageUploadingProgressError] =
    useState(null);
  console.log(imageUploadingProgress, imageUploadingProgressError);
  ...
  const uploadImage = async () => {
    setImageUploadingProgressError(null);
    ...
    uploadTask.on(
      ...
      (error) => {
        setImageUploadingProgressError("FILE SIZE HAS TO LESS THEN 2MB");
  ...
  return (
    <div className="max-w-lg mx-auto p-3 w-full">
      ...
      <form className="flex flex-col gap-4">
        ...
        {imageUploadingProgressError && (
          <Alert color="failure">{imageUploadingProgressError}</Alert>
        )}
